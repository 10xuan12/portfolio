...
<div class="container py-5">
    ...
    <form id="studentForm" method="POST" action="submit_student.php" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
            <label for="department" class="col-sm-2 col-form-label">科系</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="bio" class="col-sm-2 col-form-label">個人簡介</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="background" class="col-sm-2 col-form-label">專業背景</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="languages" class="col-sm-2 col-form-label">語言能力</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            <label for="school" class="col-sm-2 col-form-label">畢業學校</label>
            <div class="col-sm-10">
