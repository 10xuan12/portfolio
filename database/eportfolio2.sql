...
(1, '初次登入', '第一次登入系統', 'fa-user-check', '', 1),
(2, '首次上傳', '上傳第一個作品', 'fa-upload', '', 5),
(3, '完整個人檔案', '完成個人基本資料', 'fa-id-card', '', 10),
(4, '熱門作品', '作品瀏覽數破 100', 'fa-fire', '', 100),
(5, '明星創作者', '累積 10 個讚', 'fa-star', '', 10);
...
(1, '網頁設計', 'web', '網站設計與開發相關作品', 'fas fa-globe', '#667eea', 1, 1, '2025-08-29 06:29:47'),
(2, '行動應用', 'mobile', '手機應用程式開發', 'fas fa-mobile-alt', '#f093fb', 2, 1, '2025-08-29 06:29:47'),
(3, 'UI/UX 設計', 'design', '使用者介面與體驗設計', 'fas fa-palette', '#4facfe', 3, 1, '2025-08-29 06:29:47'),
(4, '數據分析', 'data', '數據分析與視覺化', 'fas fa-chart-bar', '#43e97b', 4, 1, '2025-08-29 06:29:47'),
(5, '其他', 'other', '其他類型的作品', 'fas fa-ellipsis-h', '#fa709a', 5, 1, '2025-08-29 06:29:47'),
(11, '網頁開發', 'web-development', '前端和後端網頁應用程式開發', 'code', '#3B82F6', 1, 1, '2025-08-29 06:59:43'),
(12, '資料分析', 'data-analysis', '數據處理、分析和視覺化', 'bar-chart', '#10B981', 2, 1, '2025-08-29 06:59:43'),
(13, '數位行銷', 'digital-marketing', '社群媒體行銷、SEO、內容行銷', 'megaphone', '#F59E0B', 3, 1, '2025-08-29 06:59:43'),
(14, '使用者體驗', 'user-experience', 'UI/UX 設計、使用者研究', 'users', '#8B5CF6', 4, 1, '2025-08-29 06:59:43'),
(15, '專案管理', 'project-management', '專案規劃、執行和監控', 'folder', '#EF4444', 5, 1, '2025-08-29 06:59:43');
...
INSERT INTO `comments` (`id`, `portfolio_id`, `user_id`, `parent_id`, `content`, `rating`, `is_approved`, `created_at`, `updated_at`) VALUES
(1, 6, 5, NULL, '這份分析報告非常詳細，數據視覺化做得很好！', 5, 1, '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(2, 7, 5, NULL, '策略規劃很實用，對中小企業很有幫助。', 4, 1, '2025-08-29 07:10:55', '2025-08-29 07:10:55');
...
(1, 5, 'like', '您的作品收到了新的讚', '有人對您的作品「電商網站使用者行為分析」按讚了！', '{\"portfolio_id\": 1, \"liker_name\": \"匿名用戶\"}', 0, '2025-08-29 07:10:55'),
(2, 5, 'comment', '您的作品收到了新的評論', '有人對您的作品「社群媒體行銷策略規劃」發表了評論。', '{\"portfolio_id\": 2, \"commenter_name\": \"匿名用戶\", \"comment\": \"策略規劃很實用，對中小企業很有幫助。\"}', 0, '2025-08-29 07:10:55');
...
(6, 5, '電商網站使用者行為分析', '使用 Python 和 PowerBI 分析電商網站的用戶行為數據，包括瀏覽路徑、購買轉換率、用戶分群等，為行銷策略提供數據支持。', 12, 'Python, PowerBI, 數據分析, 電商, 用戶行為', 'published', '/portfolio/uploads/portfolios/ecommerce-analysis.jpg', '## 專案概述\n\n本專案旨在分析電商網站的用戶行為數據，透過數據挖掘和視覺化技術，深入了解用戶的瀏覽習慣和購買行為。\n\n## 技術工具\n- Python (pandas, numpy, matplotlib)\n- PowerBI\n- SQL\n- Excel\n\n## 主要發現\n1. 用戶平均瀏覽時間為 8.5 分鐘\n2. 購物車放棄率為 68%\n3. 最受歡迎的產品類別是電子產品\n\n## 改進建議\n1. 優化購物車流程\n2. 增加產品推薦功能\n3. 改善移動端體驗', 156, 23, 0, 0, 1, '2024-12-01 02:00:00', '2025-08-29 07:07:41', '2025-08-29 07:07:41'),
(7, 5, '社群媒體行銷策略規劃', '為中小企業制定完整的社群媒體行銷策略，包括內容規劃、發布時程、互動策略和成效追蹤。', 13, '社群媒體, 行銷策略, 內容規劃, 品牌推廣', 'published', '/portfolio/uploads/portfolios/social-media-strategy.jpg', '## 專案背景\n\n協助台中地區的中小企業建立有效的社群媒體行銷策略，提升品牌知名度和客戶互動。\n\n## 策略內容\n1. 平台選擇：Facebook、Instagram、Line\n2. 內容主題：產品介紹、客戶故事、產業知識\n3. 發布頻率：每週 3-4 篇\n4. 互動策略：回覆評論、舉辦活動\n\n## 成效指標\n- 粉絲增長率：每月 15%\n- 互動率：平均 8%\n- 網站流量：提升 25%', 89, 15, 0, 0, 0, '2024-11-15 06:30:00', '2025-08-29 07:07:41', '2025-08-29 07:07:41'),
(8, 5, '學生資訊系統 UI/UX 設計', '重新設計學校資訊系統的使用者介面，提升學生和教師的使用體驗，包括響應式設計和無障礙功能。', 14, 'UI/UX設計, 響應式設計, 無障礙設計, 使用者研究', 'published', '/portfolio/uploads/portfolios/student-system-ui.jpg', '## 設計目標\n\n改善現有學生資訊系統的使用者體驗，讓學生和教師能夠更有效率地使用系統功能。\n\n## 設計原則\n1. 簡潔明瞭的介面\n2. 直觀的操作流程\n3. 響應式設計\n4. 無障礙功能\n\n## 主要改進\n- 重新設計導航結構\n- 優化表單設計\n- 增加搜尋功能\n- 改善移動端體驗\n\n## 使用者測試\n- 測試對象：20 名學生，5 名教師\n- 完成任務成功率：95%\n- 使用者滿意度：4.2/5.0', 234, 31, 0, 0, 1, '2024-10-20 01:15:00', '2025-08-29 07:07:41', '2025-08-29 07:07:41'),
(9, 5, 'Python 爬蟲程式開發', '開發自動化網頁爬蟲程式，用於收集和分析網路數據，支援多種網站格式和反爬蟲機制。', 11, 'Python, 爬蟲, 自動化, 數據收集, Selenium', 'published', '/portfolio/uploads/portfolios/python-scraper.jpg', '## 專案描述\n\n開發一個功能完整的網頁爬蟲系統，能夠自動化收集網路數據，支援多種網站格式和反爬蟲機制。\n\n## 技術特點\n- 使用 Selenium 處理動態內容\n- 支援多線程爬取\n- 自動處理反爬蟲機制\n- 數據清洗和格式化\n\n## 主要功能\n1. 自動化登入\n2. 數據提取\n3. 錯誤處理\n4. 數據導出\n\n## 應用場景\n- 電商價格監控\n- 新聞內容收集\n- 社交媒體分析\n- 市場研究數據', 178, 28, 0, 0, 0, '2024-09-10 08:45:00', '2025-08-29 07:07:41', '2025-08-29 07:07:41'),
(10, 5, '專案管理系統開發', '使用 React 和 Node.js 開發專案管理系統，包含任務分配、進度追蹤、團隊協作等功能。', 15, 'React, Node.js, 專案管理, 團隊協作, 任務追蹤', 'published', '/portfolio/uploads/portfolios/project-management-system.jpg', '## 系統功能\n\n開發一個完整的專案管理系統，幫助團隊更有效率地協作和追蹤專案進度。\n\n## 核心功能\n1. 專案建立和管理\n2. 任務分配和追蹤\n3. 團隊成員管理\n4. 進度報告\n5. 檔案共享\n\n## 技術架構\n- 前端：React + TypeScript\n- 後端：Node.js + Express\n- 資料庫：MySQL\n- 即時通訊：Socket.io\n\n## 專案成果\n- 開發週期：3 個月\n- 團隊規模：5 人\n- 使用者反饋：4.5/5.0', 145, 19, 0, 0, 0, '2024-08-25 03:20:00', '2025-08-29 07:07:41', '2025-08-29 07:07:41'),
(11, 5, '電商網站使用者行為分析', '使用 Python 和 PowerBI 分析電商網站的用戶行為數據，包括瀏覽路徑、購買轉換率、用戶分群等，為行銷策略提供數據支持。', 12, 'Python, PowerBI, 數據分析, 電商, 用戶行為', 'published', '/portfolio/uploads/portfolios/ecommerce-analysis.jpg', '## 專案概述\n\n本專案旨在分析電商網站的用戶行為數據，透過數據挖掘和視覺化技術，深入了解用戶的瀏覽習慣和購買行為。\n\n## 技術工具\n- Python (pandas, numpy, matplotlib)\n- PowerBI\n- SQL\n- Excel\n\n## 主要發現\n1. 用戶平均瀏覽時間為 8.5 分鐘\n2. 購物車放棄率為 68%\n3. 最受歡迎的產品類別是電子產品\n\n## 改進建議\n1. 優化購物車流程\n2. 增加產品推薦功能\n3. 改善移動端體驗', 156, 23, 0, 0, 1, '2024-12-01 02:00:00', '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(12, 5, '社群媒體行銷策略規劃', '為中小企業制定完整的社群媒體行銷策略，包括內容規劃、發布時程、互動策略和成效追蹤。', 13, '社群媒體, 行銷策略, 內容規劃, 品牌推廣', 'published', '/portfolio/uploads/portfolios/social-media-strategy.jpg', '## 專案背景\n\n協助台中地區的中小企業建立有效的社群媒體行銷策略，提升品牌知名度和客戶互動。\n\n## 策略內容\n1. 平台選擇：Facebook、Instagram、Line\n2. 內容主題：產品介紹、客戶故事、產業知識\n3. 發布頻率：每週 3-4 篇\n4. 互動策略：回覆評論、舉辦活動\n\n## 成效指標\n- 粉絲增長率：每月 15%\n- 互動率：平均 8%\n- 網站流量：提升 25%', 89, 15, 0, 0, 0, '2024-11-15 06:30:00', '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(13, 5, '學生資訊系統 UI/UX 設計', '重新設計學校資訊系統的使用者介面，提升學生和教師的使用體驗，包括響應式設計和無障礙功能。', 14, 'UI/UX設計, 響應式設計, 無障礙設計, 使用者研究', 'published', '/portfolio/uploads/portfolios/student-system-ui.jpg', '## 設計目標\n\n改善現有學生資訊系統的使用者體驗，讓學生和教師能夠更有效率地使用系統功能。\n\n## 設計原則\n1. 簡潔明瞭的介面\n2. 直觀的操作流程\n3. 響應式設計\n4. 無障礙功能\n\n## 主要改進\n- 重新設計導航結構\n- 優化表單設計\n- 增加搜尋功能\n- 改善移動端體驗\n\n## 使用者測試\n- 測試對象：20 名學生，5 名教師\n- 完成任務成功率：95%\n- 使用者滿意度：4.2/5.0', 234, 31, 0, 0, 1, '2024-10-20 01:15:00', '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(14, 5, 'Python 爬蟲程式開發', '開發自動化網頁爬蟲程式，用於收集和分析網路數據，支援多種網站格式和反爬蟲機制。', 11, 'Python, 爬蟲, 自動化, 數據收集, Selenium', 'published', '/portfolio/uploads/portfolios/python-scraper.jpg', '## 專案描述\n\n開發一個功能完整的網頁爬蟲系統，能夠自動化收集網路數據，支援多種網站格式和反爬蟲機制。\n\n## 技術特點\n- 使用 Selenium 處理動態內容\n- 支援多線程爬取\n- 自動處理反爬蟲機制\n- 數據清洗和格式化\n\n## 主要功能\n1. 自動化登入\n2. 數據提取\n3. 錯誤處理\n4. 數據導出\n\n## 應用場景\n- 電商價格監控\n- 新聞內容收集\n- 社交媒體分析\n- 市場研究數據', 178, 28, 0, 0, 0, '2024-09-10 08:45:00', '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(15, 5, '專案管理系統開發', '使用 React 和 Node.js 開發專案管理系統，包含任務分配、進度追蹤、團隊協作等功能。', 15, 'React, Node.js, 專案管理, 團隊協作, 任務追蹤', 'published', '/portfolio/uploads/portfolios/project-management-system.jpg', '## 系統功能\n\n開發一個完整的專案管理系統，幫助團隊更有效率地協作和追蹤專案進度。\n\n## 核心功能\n1. 專案建立和管理\n2. 任務分配和追蹤\n3. 團隊成員管理\n4. 進度報告\n5. 檔案共享\n\n## 技術架構\n- 前端：React + TypeScript\n- 後端：Node.js + Express\n- 資料庫：MySQL\n- 即時通訊：Socket.io\n\n## 專案成果\n- 開發週期：3 個月\n- 團隊規模：5 人\n- 使用者反饋：4.5/5.0', 145, 19, 0, 0, 0, '2024-08-25 03:20:00', '2025-08-29 07:10:55', '2025-08-29 07:10:55'),
(16, 5, '我的第一個作品', '這是一個範例作品描述', 4, '範例,Demo', 'published', NULL, '內容...', 10, 2, 0, 0, 0, '2025-08-29 07:59:32', '2025-08-29 07:59:32', '2025-08-29 07:59:32');
